...
class BasketItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create basket_item" do
    assert_difference('BasketItem.count') do
      post basket_items_url, params: { basket_item: { basket_id: @basket_item.basket_id, shoe_id: @basket_item.shoe_id } }
    end
  ...
  test "should update basket_item" do
    patch basket_item_url(@basket_item), params: { basket_item: { basket_id: @basket_item.basket_id, shoe_id: @basket_item.shoe_id } }
